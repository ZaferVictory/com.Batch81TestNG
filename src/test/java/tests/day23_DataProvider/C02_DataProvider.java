...
public class C02_DataProvider {
    ...
    public static Object[][] kullanıcılar() {
        return new Object[][]{{"erol@gmail","12345"},{"tepe@gmail.com","32154"},{"ahmet@gmail.com","54689"}};
    }
    ...
    public void test01(String userEmail,String password) {
        ...
        Assert.assertTrue(brc.ikincilogin.isDisplayed());// basarılı girş olsaydı 2.logın gorulmeyecektı ya ondan loogın
                                                       // butonunu aldım
